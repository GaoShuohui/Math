...
$\vec{OA_k}=\left ( R\cos\frac{2\pi k}{n}\cos \varphi ,R\sin\frac{2\pi k}{n},R \cos\frac{2\pi k}{n}\sin\varphi \right )
\vec{F_k}=\left ( F_k\cos\frac{2\pi k}{n}\cos\varphi ,F_k\sin\frac{2\pi k}{n}\cos\varphi ,F_k\sin\varphi  \right )$
